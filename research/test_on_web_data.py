...
Examples:
  ...
  # Custom web data size
  python -m research.test_on_web_data --num-samples-per-class 100
  ...
  python -m research.test_on_web_data --dataset ISOT
    ...
    parser.add_argument(
        ...
        type=int,
        default=50,
        help='Web samples per class (default: 50)'
    )
    ...
    # print("[Creating web-scraped test data]")
    # web_data = create_simulated_web_data(
    #     num_real=args.num_samples_per_class,
    #     num_fake=args.num_samples_per_class
    # )
    # print(f"Created {len(web_data)} web samples\n")
